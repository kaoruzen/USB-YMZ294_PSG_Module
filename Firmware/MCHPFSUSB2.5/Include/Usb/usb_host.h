...
/****************************************************************************
  Function:
    BYTE USBHostGetStringDescriptor ( BYTE deviceAddress,  BYTE stringNumber,
                        BYTE *stringDescriptor, BYTE stringLength, BYTE clientDriverID )
...
#define USBHostGetStringDescriptor( deviceAddress, stringNumber, stringDescriptor, stringLength, clientDriverID )                   \
        USBHostIssueDeviceRequest( deviceAddress, USB_SETUP_DEVICE_TO_HOST | USB_SETUP_TYPE_STANDARD | USB_SETUP_RECIPIENT_DEVICE,   \
                ...
                0, stringLength, stringDescriptor, USB_DEVICE_REQUEST_GET, clientDriver )
